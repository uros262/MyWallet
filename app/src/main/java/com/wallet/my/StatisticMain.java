        ...
        switch (id) {
            case R.id.mBackupDatabase:
                ...
                try {
                    ...
                    client.post("http://192.168.1.88/mywalletbackup/insertuser.php", params, new AsyncHttpResponseHandler() {
...
//                    ex.getMessage();
            ...
            case R.id.mRestoreDatabase:
                ...
                try {
                    ...
                    client.get("http://192.168.1.88/mywalletbackup/insertuser.php?giveMeBackup=true", new JsonHttpResponseHandler() {
                        @Override
